...
\begin{document}
	...
	\section{Data Storage}\label{sec:data_storage}
		...
		Modern pipelines are are complex and can hindered by I/O.
	...
	\section{Preprocessing}\label{sec:preprocessing}
		Most data needs some preprocessing to remove background or clean up unwanted signal \cite{Aaron2019,NEEDED}.
